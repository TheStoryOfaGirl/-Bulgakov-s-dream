...
public class DialogueManager : MonoBehaviour
{
    ...
    {
        if (inputField.text == "Азазелло" || inputField.text == "Мастер и Маргарита" || inputField.text == "Воланд и Фагот" || inputField.text == "Фагот и Воланд" 
            || inputField.text == "Маргарита и Мастер" || inputField.text == "Воланд и Коровьев" || inputField.text == "Коровьев и Воланд")
        {
            inputField.text = "";
            flag = false;
        }
